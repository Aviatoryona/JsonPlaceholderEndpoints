 ...
 */
@Stateless
public class TodoServiceImpl extends AbstractBeanImpl<ToDo, Long> implements TodoService {
    ...
    public List<ToDo> getUserToDos(Long userId) {
        Query q = getEntityManager().createNamedQuery(ToDo.GETUSER_TODO, Post.class);
